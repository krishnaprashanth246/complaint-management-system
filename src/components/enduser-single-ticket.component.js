...
import EnduserEditTicketComponent from './enduser-edit-ticket.component';
import { Link, Redirect } from 'react-router-dom';

class EndUserSingleTicket extends Component{
    constructor(props)
    {
        super(props);
        ...
        this.state = {
            categoryName: '',
            endUser: JSON.parse(localStorage.getItem("loginData")).profileObj.email.split('@')[0],
            ticketInfo: '',
            assignedTechnician:'',
            lastUpdated: '',
            ticketStatus: '',
    ...
    componentDidMount(){
      ...
      onSubmit(e) {
        ...
        this.props.history.push(`/enduser/tickets/edit/${this.props.match.params.id}`)
    }
...
export default withRouter(EndUserSingleTicket);