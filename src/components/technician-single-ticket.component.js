...
import TechnicianEditTicketComponent from './technician-edit-ticket.component';

class TechnicianSingleTicket extends Component{
    constructor(props)
    {
        super(props);
    ...
    componentDidMount(){
      ...
      onSubmit(e) {
        ...
        this.props.history.push(`/technician/tickets/edit/${this.props.match.params.id}`)
    }
...
export default withRouter(TechnicianSingleTicket);